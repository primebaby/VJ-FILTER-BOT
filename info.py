...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002096410592').split()]  # For Multiple Id Use One Space Between Each.
...
#auth_channel = environ.get('AUTH_CHANNEL', '-1002237171878') # give your force subscribe channel id here else leave it blan
AUTH_CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNELS', '-1001948532295 -1001622914589').split()]
# Backward compatibility for old code expecting a single AUTH_CHANNEL
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://maxine11229:2d0NThJZDM9iSu48@cluster0.9qvbj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_bot_disscusion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movie_loverzz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscssion') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://profound-nance-wickson-62929175.koyeb.app/")
